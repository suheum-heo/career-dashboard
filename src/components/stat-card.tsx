  ...
  const card = (
    <Card
      className={cn(
        ...
        href &&
          "h-full hover:border-primary/40 hover:bg-accent/30 group-data-[pressed=true]:scale-[0.98] group-data-[pressed=true]:border-primary/50 group-data-[pressed=true]:bg-accent/40 group-data-[pressed=true]:opacity-80"
      )}
    >
